...
def anomaly_scores_sig_bkg(
    ...
    true_labels = np.concatenate([
        np.ones_like(sig_scores[KEY_MSE]),
        -np.ones_like(bkg_scores[KEY_MSE])
    ])
...
def anomaly_scores(
    ...
    return {
        ...
        KEY_MSE_NORM: img_MSE(recons_normalized, target_normalized).detach().cpu().numpy(),
    }
